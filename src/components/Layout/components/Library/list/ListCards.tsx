...
export const CollapsedCard = (props: CardShortProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`image h-full items-center ${
...
const CardList = (props: CardShortProps) => {
    ...
    <button
      ...
      onClick={async (e) => {
        ...
        return playerService.startPlayback(
          !isCurrent ? { context_uri: props.uri } : undefined,
        );
      }}
    >
  ...
  return (
    ...
    >
      <div
        className={`image p-2 h-full items-center ${
          props.rounded ? 'rounded' : ''
        }`}
      >
      ...
      >
        ...
        <div style={{ padding: 8 }}>
          {isCurrent ? (
            <SpeakerIcon fill="#01a085" height={16} width={16} />
          ) : null}
        </div>
      </div>
    </button>
